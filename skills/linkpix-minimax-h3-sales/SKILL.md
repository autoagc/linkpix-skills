...
qhkit video generate '{"modelLabel":"MiniMax H3","duration":15,"prompt":"户外工作灯，超长续航，露营必备","uploadedImages":["./商品图.jpg"],"orientationLabel":"竖屏 9:16"}'
...
qhkit video estimate '{"modelLabel":"MiniMax H3","duration":15,"uploadedImages":["./商品图.jpg"]}'
```
